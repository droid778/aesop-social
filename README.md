...
1. SSH into your linux machine (skip if running locally)
2. Clone the repo
3. Add a .env file containing the passwords.  This is excluded purposefully to prevent password reuse.  The easiest way is to copy / paste this into a text editor (one that doesn't have AI features, like sublime text).  Then edit the passwords (KeypassXC has a good keygen, click the dice).  Then in a terminal:
